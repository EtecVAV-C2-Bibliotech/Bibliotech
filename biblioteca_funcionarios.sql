...
--
-- Host: 127.0.0.1
-- Tempo de geração: 21/09/2025 às 18:15
...
--
CREATE DATABASE IF NOT EXISTS `biblioteca_funcionarios` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
('root', '[{\"db\":\"biblioteca_funcionarios\",\"table\":\"funcionarios\"},{\"db\":\"biblioteca_funcionarios\",\"table\":\"emprestimos\"},{\"db\":\"funcion\\u00e1rios_biblio\",\"table\":\"funcionarios\"},{\"db\":\"funcion\\u00e1rios_biblio\",\"table\":\"Funcionarios\"},{\"db\":\"agenda\",\"table\":\"telefones\"}]');
...
('root', '2025-09-21 16:10:48', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt_BR\",\"NavigationWidth\":0}');
